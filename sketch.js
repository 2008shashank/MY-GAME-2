...
function draw(){
  ...
  fill('green');
  text("RULES: ",30,160);
  text("1) YOU GET 6 CHANCES TO GUESS THE WORD",30,200);
...
// if the letter isn't part of that word start drawing the hangman


//check wheter the guess word is already guessed


//check the player if they are using some help


//Check wheter user won or lost


//Player won should display on screen


//then the screen goes black to show the next word
